...
var BoundingBox = (function () {
    ...
    BoundingBox.prototype.clone = function () {
        return new BoundingBox(this.parent, this._x, this._y, this._width, this._height).setBorder(this._border);
    };
    BoundingBox.prototype.getBorder = function () {
        return this._border;
    };
    BoundingBox.prototype.setBorder = function (top, right, bottom, left) {
    ...
    BoundingBox.prototype.getOnlyBorder = function () {
        return this._onlyBorder;
    };
    BoundingBox.prototype.setOnlyBorder = function (value) {
...
var Entity = (function (_super) {
    ...
    function Entity(scene, x, y) {
        ...
        _this.y = y;
        var restitution = 0.9;
        _this.setName(_this.constructor.name);
