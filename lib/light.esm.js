...
function debugCenter(context, entity) {
    ...
    var x = entity.x + (isMouse ? 0 : entity.scene.camera.x);
    var y = entity.y + (isMouse ? 0 : entity.scene.camera.y);
    context.beginPath();
    ...
    if (isCircle) {
        ...
        context.arc(entity.x, entity.y, entity.radius * entity.getScale().r, 0, Math.PI * 2);
        context.stroke();
        context.closePath();
    }
    else if (!isMouse) {
                    ...
                    if (e.y < e.height / 2) {
                        ...
                        if (e.box.rebound)
                            e.vy =
                                -Math.abs(e.vy) *
                                    (restitution + (e._bounceWithoutLosingSpeed ? 0.1 : 0));
                        e.y = e.box.getHeight() - e.height / 2;
                    }
                }
            }
            else if (e.isMoving)
