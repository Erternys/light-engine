...
function debugCenter(context, x, y) {
    context.beginPath();
...
var CloneAudioManager = (function (_super) {
    ...
    function CloneAudioManager(audio, key) {
        var _this = _super.call(this) || this;
        ...
        _this.getAudio(_this.audio.src)
            ...
            .catch(function (reason) { return _this.globals.emit("error", reason); });
...
var AudioManager = (function (_super) {
    ...
    AudioManager.prototype.createClone = function () {
        var clone = new CloneAudioManager(this.audio, this.key);
...
var Entity = (function (_super) {
    ...
    function Entity(scene, x, y) {
        ...
        _this._speed = 1;
        _this._gravity = 0;
        _this._bounceWithoutLosingSpeed = true;
        _this.scene = scene;
        _this.box = (_a = scene === null || scene === void 0 ? void 0 : scene.world) === null || _a === void 0 ? void 0 : _a.bounds;
        _this.x = x;
        _this.y = y;
        var restitution = 0.9;
        _this.on("move:velocity", function () {
            var _a, _b;
            if (!_this.isMoving)
                _this.isMoving = true;
            _this.x += _this.vx * _this._speed * _this.scene.game.secondsPassed;
            _this.y +=
                _this.vy * (_this._gravity || _this._speed) * _this.scene.game.secondsPassed;
            if ((_b = (_a = _this.box) === null || _a === void 0 ? void 0 : _a.parent) === null || _b === void 0 ? void 0 : _b.isActive) {
                if (typeOf(_this) === "Circle") {
                    if (_this.x < _this.radius) {
                        if (_this.isMoving)
                            _this.isMoving = false;
                        _this.vx = Math.abs(_this.vx) * restitution;
                        _this.x = _this.radius;
                    }
                    else if (_this.x >
                        _this.box.getWidth() - _this.radius) {
                        if (_this.isMoving)
                            _this.isMoving = false;
                        _this.vx = -Math.abs(_this.vx) * restitution;
                        _this.x = _this.box.getWidth() - _this.radius;
                    }
                    if (_this.y < _this.radius) {
                        if (_this.isMoving)
                            _this.isMoving = false;
                        _this.vy = Math.abs(_this.vy) * restitution;
                        _this.y = _this.radius;
                    }
                    else if (_this.y >
                        _this.box.getHeight() - _this.radius) {
                        if (_this.isMoving)
                            _this.isMoving = false;
                        _this.vy = -Math.abs(_this.vy) * restitution;
                        _this.y = _this.box.getHeight() - _this.radius;
                    }
                }
                else if (typeOf(_this) === "Rectangle") {
                    if (_this.x < _this.width / 2) {
                        if (_this.isMoving)
                            _this.isMoving = false;
                        if (_this.box.rebound)
                            _this.vx =
                                Math.abs(_this.vx) *
                                    (restitution + (_this._bounceWithoutLosingSpeed ? 0.1 : 0));
                        _this.x = _this.width / 2;
                    }
                    else if (_this.x >
                        _this.box.getWidth() - _this.width / 2) {
                        if (_this.isMoving)
                            _this.isMoving = false;
                        if (_this.box.rebound)
                            _this.vx =
                    ...
                    if (_this.y < _this.height / 2) {
                        ...
                        _this.box.getHeight() - _this.height / 2) {
                        if (_this.isMoving)
                            _this.isMoving = false;
                        if (_this.box.rebound)
                            _this.vy =
    ...
    Entity.prototype.setOrigineX = function (value) {
        if (this.originX !== value)
            this.originX = value;
        return this;
    };
    Entity.prototype.setOrigineY = function (value) {
        if (this.originY !== value)
            this.originY = value;
        return this;
    };
    Entity.prototype.setOrigine = function (vx, vy) {
        this.setOrigineX(vx);
        this.setOrigineY(vy !== null && vy !== void 0 ? vy : vx);
        return this;
    };
    Entity.prototype.getOrigine = function () {
        return {
            x: this.originX,
            y: this.originY,
        };
    ...
    Entity.prototype.collideRect = function (rect1, rect2) {
        return !(rect1.x - rect1.width / 2 > rect2.width + rect2.x - rect2.width / 2 ||
    ...
    Entity.prototype.collideCircWorld = function (circle, rect) {
        ...
        if (circleDistanceX > rect.getWidth() + circle.radius ||
    ...
    Entity.prototype.collideRectWorld = function (rect1, rect2) {
        return !(rect1.x - rect1.width / 2 > rect2.getWidth() + rect2.getX() ||
    ...
    Entity.prototype.toJSON = function (entityProperties) {
        ...
        entityProperties.forEach(function (property) {
            properties[property] = property in _this ? _this[property] : null;
        });
        return __assign({ x: this.x, y: this.y, box: this.box, name: this.name, width: this.width, height: this.height }, properties);
    };
    return Entity;
}(EventEmitter));
...
var Rectangle = (function (_super) {
    ...
    Rectangle.prototype.draw = function (context) {
        ...
        context.translate(this.width * this.originX * this.scalex, this.height * this.originY * this.scaley);
        ...
        if (this.scene.game.debug)
            debugCenter(context, this.x, this.y);
    };
...
var Circle = (function (_super) {
    ...
    Circle.prototype.draw = function (context) {
        ...
        if (isDefined(this.fillColor)) {
            context.beginPath();
            context.fillStyle = this.fillColor.toString(16);
            context.arc(this.x - this.scene.camera.x, this.y - this.scene.camera.y, this.radius * this.scaler, 0, Math.abs(angle), angle >= 0);
            context.fill();
        }
        if (isDefined(this.strokeColor)) {
            context.beginPath();
        ...
        context.setTransform(1, 0, 0, 1, 0, 0);
        if (this.scene.game.debug)
            debugCenter(context, this.x - this.scene.camera.x, this.y - this.scene.camera.y);
    };
    return Circle;
}(Entity));
...
var Sprite = (function (_super) {
    ...
    Sprite.prototype.fromSave = function () { };
...
var Text$1 = (function (_super) {
    ...
    Text.prototype.draw = function (context) {
        ...
        if (isDefined(this.fillColor)) {
            context.fillStyle = this.fillColor.toString(16);
            context.fillText(this.content, this.x + this.style.padding.left + align, this.y + this.style.padding.top);
        }
        if (isDefined(this.strokeColor)) {
            context.lineWidth = this.lineWidth;
            context.strokeStyle = this.strokeColor.toString(16);
    ...
    Text.prototype.fromSave = function () { };
...
var Scene = (function (_super) {
    ...
    Scene.prototype.getAudio = function (name) {
        ...
        if (audio)
            return new AudioManager(audio, name);
    };
...
var Game = (function (_super) {
    ...
    function Game(config, w, h) {
        ...
        if (typeof config.loadScene !== "undefined") {
            ...
            _this.playScene(config.loadScene);
        }
    ...
    Game.prototype.update = function (o) {
        ...
        for (var _i = 0, entities_2 = entities; _i < entities_2.length; _i++) {
            ...
            if (entity.collide(this.mouse))
                entity.emit("mouse:hover", entity);
...
export { Game, loaders as Loaders, index$2 as Managers, index$1 as Objects };
