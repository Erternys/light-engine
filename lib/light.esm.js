...
var CloneAudioManager = (function (_super) {
    ...
    function CloneAudioManager(audio, key) {
        ...
        _this.isLocal = /^file:\/\/\//.test(location.href);
        if (!_this.isLocal)
...
var Camera = (function (_super) {
    ...
    function Camera(scene) {
        ...
        _this.center = new BoundingBox(scene, "50%", "50%", 2, 2);
        _this.width = scene.game.canvas.width;
        _this.height = scene.game.canvas.height;
        return _this;
    }
...
var Scene = (function (_super) {
    ...
    Scene.prototype.getAudio = function (name) {
        ...
        if (audio) {
            var manager = new AudioManager(audio, name);
...
var Game = (function (_super) {
    ...
    function Game(config, w, h, doc, win) {
        ...
        __spreadArrays(toLoad, [function () { }]).forEach(function (name, i) {
...
export { EventEmitter, Game, loaders as Loaders, index$2 as Managers, index$1 as Objects };
