...
var Rectangle = (function (_super) {
    ...
    Rectangle.prototype.draw = function (context) {
        ...
        if (isDefined(this.strokeColor)) {
            ...
            context.strokeRect(this.x, this.y, this.width * this.scalex, this.height * this.scaley);
        }
...
var Image = (function (_super) {
    ...
    Image.prototype.draw = function (context) {
        ...
        if (isDefined(image)) {
            ...
            context.drawImage(image, this.x - this.scene.camera.x, this.y - this.scene.camera.y, this.width * this.scalex, this.height * this.scaley);
        }
        context.setTransform(1, 0, 0, 1, 0, 0);
        if (this.scene.game.debug)
            debugCenter(context, this.x - this.scene.camera.x, this.y - this.scene.camera.y);
...
var Sprite = (function (_super) {
    ...
    Sprite.prototype.draw = function (context) {
        ...
        if (isDefined(image)) {
            ...
            context.drawImage(image, this.sprite.x, this.sprite.y, this.sprite.width, this.sprite.height, this.x, this.y, this.width * this.scalex, this.height * this.scaley);
        }
        context.setTransform(1, 0, 0, 1, 0, 0);
        if (this.scene.game.debug)
            debugCenter(context, this.x, this.y);
...
var Game = (function (_super) {
    ...
    function Game(config, w, h) {
        ...
        if (config.pixel)
            _this.canvas.style.imageRendering = isChromium() ? "pixelated" : "crisp-edges";
