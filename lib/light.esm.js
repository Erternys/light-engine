...
var Timer = (function (_super) {
    ...
    function Timer(scene, callback, o, unique) {
        ...
        _this.scene.game.on("updated", _this.update);
        _this.setTimeWait(o);
        return _this;
    }
...
var Game = (function (_super) {
    ...
    Game.prototype.initScene = function (scene) {
        ...
        if (scene.isPlayed === "main") {
            for (var _b = 0, _c = this.playedWithOpacity; _b < _c.length; _b++) {
                var scene_1 = _c[_b];
    ...
    Game.prototype.update = function (o) {
        ...
        for (var _d = 0, entities_3 = entities; _d < entities_3.length; _d++) {
            var entity = entities_3[_d];
            if (!entity.hidden)
        ...
        for (var _e = 0, _f = this.playedWithOpacity; _e < _f.length; _e++) {
            ...
            for (var _g = 0, entities_4 = entities_6; _g < entities_4.length; _g++) {
                var entity = entities_4[_g];
                if (!entity.hidden)
                    entity.draw(this.context);
                entity.afterRedraw();
            }
